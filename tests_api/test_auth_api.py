...
def test_API_AU01_valid_login(playwright, base_url):
...
def test_API_AU02_login_no_email(playwright, base_url):
    api = playwright.request.new_context(base_url=base_url)
...
def test_API_AU03_delete_to_verify_login(playwright, base_url):
    api = playwright.request.new_context(base_url=base_url)
...
def test_API_AU04_invalid_login(playwright, base_url):
    api = playwright.request.new_context(base_url=base_url)
